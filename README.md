This project is a simple (at least for now) app to create lists of medications (or anything else) to use built with React, Redux, React Final Forms and Material UI.
